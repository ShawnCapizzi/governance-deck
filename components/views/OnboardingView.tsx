...
export default function OnboardingView() {
  ...
  if (loading) {
    return wrap(<Widget eyebrow="Setup" title="Checking your account"><p className="text-sm text-ink-2">One moment.</p></Widget>);
  }

  if (!user) {
    return wrap(
      <Widget eyebrow="Setup" title="Sign in first" icon={<IconRoles size={19} />}>
  ...
  return wrap(
    <div className="grid gap-4 md:grid-cols-2">
      <Widget eyebrow="How this works" title="Create an organization" sub="You become the owner"
      ...
      <Widget eyebrow="Setup" title="Join with a code" sub="From a teammate" icon={<IconRoles size={19} />}>
        <p className="text-sm text-ink-2 mb-4">
