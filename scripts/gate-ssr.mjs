...
const checks = {
  ...
  start: ["Run smarter, together", "Fewer meetings", "Start answering", "Try the loop", "Explore the workshop and card deck", "Start a round", "spine-card", "Deal again", "Deal three more", "mesh-hero", "raise-1"],
